...
public class ForwardingSessionStream implements SessionStream {
  private final SessionStream delegate;

  public ForwardingSessionStream(SessionStream delegate) {
