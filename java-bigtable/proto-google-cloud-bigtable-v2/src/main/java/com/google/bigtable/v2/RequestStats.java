...
private static final long serialVersionUID = 0L;
  ...
  public enum StatsViewCase
    ...
    public static StatsViewCase forNumber(int value) {
      switch (value) {
        ...
        case 2: return SIMPLE_SQL_READ_STATS_VIEW;
  ...
  public static final int SIMPLE_SQL_READ_STATS_VIEW_FIELD_NUMBER = 2;
  /**
   * <pre>
   * Available with the
   ...
   */
  @java.lang.Override
  public boolean hasSimpleSqlReadStatsView() {
    return statsViewCase_ == 2;
  }
  /**
   * <pre>
   * Available with the
   ...
   */
  @java.lang.Override
  public com.google.bigtable.v2.SimpleSqlReadStatsView getSimpleSqlReadStatsView() {
    if (statsViewCase_ == 2) {
       return (com.google.bigtable.v2.SimpleSqlReadStatsView) statsView_;
    }
   ...
   */
  @java.lang.Override
  public com.google.bigtable.v2.SimpleSqlReadStatsViewOrBuilder getSimpleSqlReadStatsViewOrBuilder() {
    if (statsViewCase_ == 2) {
       return (com.google.bigtable.v2.SimpleSqlReadStatsView) statsView_;
    }
    return com.google.bigtable.v2.SimpleSqlReadStatsView.getDefaultInstance();
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (statsViewCase_ == 2) {
      output.writeMessage(2, (com.google.bigtable.v2.SimpleSqlReadStatsView) statsView_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (statsViewCase_ == 2) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, (com.google.bigtable.v2.SimpleSqlReadStatsView) statsView_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    switch (statsViewCase_) {
      case 1:
        ...
        break;
      case 2:
        if (!getSimpleSqlReadStatsView()
            .equals(other.getSimpleSqlReadStatsView())) return false;
        break;
      case 0:
      default:
    }
  ...
  public int hashCode() {
    ...
    switch (statsViewCase_) {
      case 1:
        ...
        break;
      case 2:
        hash = (37 * hash) + SIMPLE_SQL_READ_STATS_VIEW_FIELD_NUMBER;
        hash = (53 * hash) + getSimpleSqlReadStatsView().hashCode();
        break;
      case 0:
      default:
    }
  ...
  public static final class Builder extends
    ...
    public Builder clear() {
      ...
      if (simpleSqlReadStatsViewBuilder_ != null) {
        simpleSqlReadStatsViewBuilder_.clear();
      }
      statsViewCase_ = 0;
      statsView_ = null;
      return this;
    ...
    private void buildPartialOneofs(com.google.bigtable.v2.RequestStats result) {
      ...
      if (statsViewCase_ == 2 &&
          simpleSqlReadStatsViewBuilder_ != null) {
        result.statsView_ = simpleSqlReadStatsViewBuilder_.build();
      }
    }
    ...
    public Builder mergeFrom(com.google.bigtable.v2.RequestStats other) {
      ...
      switch (other.getStatsViewCase()) {
        ...
        case SIMPLE_SQL_READ_STATS_VIEW: {
          mergeSimpleSqlReadStatsView(other.getSimpleSqlReadStatsView());
          break;
        }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  internalGetFullReadStatsViewFieldBuilder().getBuilder(),
                  extensionRegistry);
              statsViewCase_ = 1;
              break;
            } // case 10
            case 18: {
              input.readMessage(
                  internalGetSimpleSqlReadStatsViewFieldBuilder().getBuilder(),
                  extensionRegistry);
              statsViewCase_ = 2;
              break;
            } // case 18
    ...
    public com.google.bigtable.v2.FullReadStatsView.Builder getFullReadStatsViewBuilder() {
      return internalGetFullReadStatsViewFieldBuilder().getBuilder();
    }
    /**
     * <pre>
     * Available with the ReadRowsRequest.RequestStatsView.REQUEST_STATS_FULL
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        internalGetFullReadStatsViewFieldBuilder() {
      if (fullReadStatsViewBuilder_ == null) {
        if (!(statsViewCase_ == 1)) {
          statsView_ = com.google.bigtable.v2.FullReadStatsView.getDefaultInstance();
        }
        fullReadStatsViewBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            com.google.bigtable.v2.FullReadStatsView, com.google.bigtable.v2.FullReadStatsView.Builder, com.google.bigtable.v2.FullReadStatsViewOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilder<
        com.google.bigtable.v2.SimpleSqlReadStatsView, com.google.bigtable.v2.SimpleSqlReadStatsView.Builder, com.google.bigtable.v2.SimpleSqlReadStatsViewOrBuilder> simpleSqlReadStatsViewBuilder_;
    /**
     * <pre>
     * Available with the
     * ExecuteQueryRequest.RequestStatsView.REQUEST_STATS_VIEW_SIMPLE view, see
    ...
    public com.google.bigtable.v2.SimpleSqlReadStatsView getSimpleSqlReadStatsView() {
      if (simpleSqlReadStatsViewBuilder_ == null) {
        ...
        if (statsViewCase_ == 2) {
          return simpleSqlReadStatsViewBuilder_.getMessage();
        }
        return com.google.bigtable.v2.SimpleSqlReadStatsView.getDefaultInstance();
      }
    }
     ...
     * <code>.google.bigtable.v2.SimpleSqlReadStatsView simple_sql_read_stats_view = 2;</code>
     */
    public Builder setSimpleSqlReadStatsView(com.google.bigtable.v2.SimpleSqlReadStatsView value) {
      if (simpleSqlReadStatsViewBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
        ...
        simpleSqlReadStatsViewBuilder_.setMessage(value);
      }
      statsViewCase_ = 2;
      return this;
    }
     ...
     * <code>.google.bigtable.v2.SimpleSqlReadStatsView simple_sql_read_stats_view = 2;</code>
     */
    public Builder setSimpleSqlReadStatsView(
        com.google.bigtable.v2.SimpleSqlReadStatsView.Builder builderForValue) {
      if (simpleSqlReadStatsViewBuilder_ == null) {
        statsView_ = builderForValue.build();
        onChanged();
      } else {
        simpleSqlReadStatsViewBuilder_.setMessage(builderForValue.build());
      }
      statsViewCase_ = 2;
      return this;
    }
     ...
     * <code>.google.bigtable.v2.SimpleSqlReadStatsView simple_sql_read_stats_view = 2;</code>
     */
    public Builder mergeSimpleSqlReadStatsView(com.google.bigtable.v2.SimpleSqlReadStatsView value) {
      if (simpleSqlReadStatsViewBuilder_ == null) {
        if (statsViewCase_ == 2 &&
            statsView_ != com.google.bigtable.v2.SimpleSqlReadStatsView.getDefaultInstance()) {
          statsView_ = com.google.bigtable.v2.SimpleSqlReadStatsView.newBuilder((com.google.bigtable.v2.SimpleSqlReadStatsView) statsView_)
              .mergeFrom(value).buildPartial();
        } else {
          statsView_ = value;
        }
        ...
        if (statsViewCase_ == 2) {
          simpleSqlReadStatsViewBuilder_.mergeFrom(value);
        } else {
          simpleSqlReadStatsViewBuilder_.setMessage(value);
        }
      }
     ...
     * <code>.google.bigtable.v2.SimpleSqlReadStatsView simple_sql_read_stats_view = 2;</code>
     */
    public Builder clearSimpleSqlReadStatsView() {
      if (simpleSqlReadStatsViewBuilder_ == null) {
        if (statsViewCase_ == 2) {
          statsViewCase_ = 0;
          statsView_ = null;
     ...
     * <code>.google.bigtable.v2.SimpleSqlReadStatsView simple_sql_read_stats_view = 2;</code>
     */
    public com.google.bigtable.v2.SimpleSqlReadStatsView.Builder getSimpleSqlReadStatsViewBuilder() {
      return internalGetSimpleSqlReadStatsViewFieldBuilder().getBuilder();
    }
    /**
     * <pre>
     * Available with the
    ...
    @java.lang.Override
    public com.google.bigtable.v2.SimpleSqlReadStatsViewOrBuilder getSimpleSqlReadStatsViewOrBuilder() {
      if ((statsViewCase_ == 2) && (simpleSqlReadStatsViewBuilder_ != null)) {
        return simpleSqlReadStatsViewBuilder_.getMessageOrBuilder();
      } else {
        if (statsViewCase_ == 2) {
          return (com.google.bigtable.v2.SimpleSqlReadStatsView) statsView_;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilder<
        com.google.bigtable.v2.SimpleSqlReadStatsView, com.google.bigtable.v2.SimpleSqlReadStatsView.Builder, com.google.bigtable.v2.SimpleSqlReadStatsViewOrBuilder> 
        internalGetSimpleSqlReadStatsViewFieldBuilder() {
      if (simpleSqlReadStatsViewBuilder_ == null) {
        if (!(statsViewCase_ == 2)) {
          statsView_ = com.google.bigtable.v2.SimpleSqlReadStatsView.getDefaultInstance();
        }
        simpleSqlReadStatsViewBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            com.google.bigtable.v2.SimpleSqlReadStatsView, com.google.bigtable.v2.SimpleSqlReadStatsView.Builder, com.google.bigtable.v2.SimpleSqlReadStatsViewOrBuilder>(
                (com.google.bigtable.v2.SimpleSqlReadStatsView) statsView_,
                getParentForChildren(),
                isClean());
        statsView_ = null;
      }
      statsViewCase_ = 2;
      onChanged();
      return simpleSqlReadStatsViewBuilder_;
    }
  ...
  private static final com.google.protobuf.Parser<RequestStats>
      PARSER = new com.google.protobuf.AbstractParser<RequestStats>() {
    @java.lang.Override
