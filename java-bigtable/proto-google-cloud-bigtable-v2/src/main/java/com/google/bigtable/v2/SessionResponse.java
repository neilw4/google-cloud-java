...
private static final long serialVersionUID = 0L;
  ...
  private com.google.bigtable.v2.PeerLoadInfo peerLoadInfo_;
  /**
   * <code>optional .google.bigtable.v2.PeerLoadInfo peer_load_info = 8;</code>
  ...
  public com.google.bigtable.v2.PeerLoadInfo getPeerLoadInfo() {
    return peerLoadInfo_ == null ? com.google.bigtable.v2.PeerLoadInfo.getDefaultInstance() : peerLoadInfo_;
  }
  /**
   * <code>optional .google.bigtable.v2.PeerLoadInfo peer_load_info = 8;</code>
   */
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (((bitField0_ & 0x00000001) != 0)) {
      output.writeMessage(8, getPeerLoadInfo());
    }
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(8, getPeerLoadInfo());
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasPeerLoadInfo() != other.hasPeerLoadInfo()) return false;
    if (hasPeerLoadInfo()) {
      if (!getPeerLoadInfo()
  ...
  public int hashCode() {
    ...
    if (hasPeerLoadInfo()) {
      ...
      hash = (53 * hash) + getPeerLoadInfo().hashCode();
    }
    switch (payloadCase_) {
      case 1:
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.bigtable.v2.SessionResponse result) {
      ...
      if (((from_bitField0_ & 0x00000080) != 0)) {
        result.peerLoadInfo_ = peerLoadInfoBuilder_ == null
            ? peerLoadInfo_
            : peerLoadInfoBuilder_.build();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  getOpenSessionFieldBuilder().getBuilder(),
                  extensionRegistry);
              payloadCase_ = 1;
              break;
            } // case 10
            case 18: {
              input.readMessage(
                  getVirtualRpcFieldBuilder().getBuilder(),
                  extensionRegistry);
              payloadCase_ = 2;
              break;
            } // case 18
            ...
            case 50: {
              input.readMessage(
                  getGoAwayFieldBuilder().getBuilder(),
                  extensionRegistry);
              payloadCase_ = 6;
              break;
            } // case 50
            case 58: {
              input.readMessage(
                  getSessionRefreshConfigFieldBuilder().getBuilder(),
                  extensionRegistry);
              payloadCase_ = 7;
              break;
            } // case 58
            case 66: {
              input.readMessage(
                  getPeerLoadInfoFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    public com.google.bigtable.v2.VirtualRpcResponse.Builder getVirtualRpcBuilder() {
      return getVirtualRpcFieldBuilder().getBuilder();
    }
    /**
     * <pre>
     * A vRPC can result in either a successful result or an error.
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        ...
        getVirtualRpcFieldBuilder() {
      if (virtualRpcBuilder_ == null) {
        if (!(payloadCase_ == 2)) {
          payload_ = com.google.bigtable.v2.VirtualRpcResponse.getDefaultInstance();
        }
        virtualRpcBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.bigtable.v2.VirtualRpcResponse, com.google.bigtable.v2.VirtualRpcResponse.Builder, com.google.bigtable.v2.VirtualRpcResponseOrBuilder>(
    ...
    public com.google.bigtable.v2.GoAwayResponse.Builder getGoAwayBuilder() {
      return getGoAwayFieldBuilder().getBuilder();
    }
    /**
     * <code>.google.bigtable.v2.GoAwayResponse go_away = 6;</code>
     */
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        ...
        getGoAwayFieldBuilder() {
      if (goAwayBuilder_ == null) {
        if (!(payloadCase_ == 6)) {
          payload_ = com.google.bigtable.v2.GoAwayResponse.getDefaultInstance();
        }
        goAwayBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.bigtable.v2.GoAwayResponse, com.google.bigtable.v2.GoAwayResponse.Builder, com.google.bigtable.v2.GoAwayResponseOrBuilder>(
    ...
    public com.google.bigtable.v2.SessionRefreshConfig.Builder getSessionRefreshConfigBuilder() {
      return getSessionRefreshConfigFieldBuilder().getBuilder();
    }
    /**
     * <code>.google.bigtable.v2.SessionRefreshConfig session_refresh_config = 7;</code>
     */
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        ...
        getSessionRefreshConfigFieldBuilder() {
      if (sessionRefreshConfigBuilder_ == null) {
        if (!(payloadCase_ == 7)) {
          payload_ = com.google.bigtable.v2.SessionRefreshConfig.getDefaultInstance();
        }
        sessionRefreshConfigBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.bigtable.v2.SessionRefreshConfig, com.google.bigtable.v2.SessionRefreshConfig.Builder, com.google.bigtable.v2.SessionRefreshConfigOrBuilder>(
    ...
    public com.google.bigtable.v2.PeerLoadInfo getPeerLoadInfo() {
      if (peerLoadInfoBuilder_ == null) {
        ...
        return peerLoadInfoBuilder_.getMessage();
      }
    }
    /**
     * <code>optional .google.bigtable.v2.PeerLoadInfo peer_load_info = 8;</code>
    ...
    public Builder setPeerLoadInfo(com.google.bigtable.v2.PeerLoadInfo value) {
      if (peerLoadInfoBuilder_ == null) {
        ...
        peerLoadInfoBuilder_.setMessage(value);
      }
      bitField0_ |= 0x00000080;
      onChanged();
      return this;
    ...
    public Builder setPeerLoadInfo(
      ...
      if (peerLoadInfoBuilder_ == null) {
        peerLoadInfo_ = builderForValue.build();
      } else {
        peerLoadInfoBuilder_.setMessage(builderForValue.build());
      }
      bitField0_ |= 0x00000080;
      onChanged();
      return this;
    ...
    public Builder mergePeerLoadInfo(com.google.bigtable.v2.PeerLoadInfo value) {
      if (peerLoadInfoBuilder_ == null) {
        if (((bitField0_ & 0x00000080) != 0) &&
          peerLoadInfo_ != null &&
          peerLoadInfo_ != com.google.bigtable.v2.PeerLoadInfo.getDefaultInstance()) {
          getPeerLoadInfoBuilder().mergeFrom(value);
        } else {
          peerLoadInfo_ = value;
        }
      } else {
        peerLoadInfoBuilder_.mergeFrom(value);
      }
      bitField0_ |= 0x00000080;
      onChanged();
      return this;
    ...
    public com.google.bigtable.v2.PeerLoadInfo.Builder getPeerLoadInfoBuilder() {
      bitField0_ |= 0x00000080;
      onChanged();
      return getPeerLoadInfoFieldBuilder().getBuilder();
    }
    /**
     * <code>optional .google.bigtable.v2.PeerLoadInfo peer_load_info = 8;</code>
     */
    public com.google.bigtable.v2.PeerLoadInfoOrBuilder getPeerLoadInfoOrBuilder() {
      if (peerLoadInfoBuilder_ != null) {
        return peerLoadInfoBuilder_.getMessageOrBuilder();
      } else {
        return peerLoadInfo_ == null ?
            com.google.bigtable.v2.PeerLoadInfo.getDefaultInstance() : peerLoadInfo_;
      }
    }
    /**
     * <code>optional .google.bigtable.v2.PeerLoadInfo peer_load_info = 8;</code>
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        ...
        getPeerLoadInfoFieldBuilder() {
      if (peerLoadInfoBuilder_ == null) {
        peerLoadInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.bigtable.v2.PeerLoadInfo, com.google.bigtable.v2.PeerLoadInfo.Builder, com.google.bigtable.v2.PeerLoadInfoOrBuilder>(
                getPeerLoadInfo(),
                getParentForChildren(),
                isClean());
