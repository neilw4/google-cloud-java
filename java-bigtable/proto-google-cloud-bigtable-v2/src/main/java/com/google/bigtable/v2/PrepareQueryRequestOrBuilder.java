...
public interface PrepareQueryRequestOrBuilder extends
   ...
   * the query string.
   *
   * For example, if param_types= Bytes then &#64;firstName will be a
  ...
  java.util.Map<java.lang.String, com.google.bigtable.v2.Type>
  getParamTypes();
  /**
   * <pre>
   * Required. `param_types` is a map of parameter identifier strings to their
